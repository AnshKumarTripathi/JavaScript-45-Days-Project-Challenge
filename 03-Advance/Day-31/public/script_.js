...
//       const avatar = message.avatar || "default-avatar.png";
//       output.innerHTML += `<div class="chat-message"><img src="/avatars/${avatar}" alt="${
//         message.username
//       }" class="avatar"><strong>${message.username}:</strong> ${
//         message.text
//       } <em>${new Date(message.timestamp).toLocaleString()}</em></div>`;
//     });
//   } catch (error) {
